...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_V9BET - Discover The Ultimate Gaming E_9e709f/input__Password'), 
    'gfxZjaFn62VSVLVP+OdZwg==')

WebUI.waitForPageLoad(10)

WebUI.click(findTestObject('Object Repository/Page_V9BET - Discover The Ultimate Gaming E_9e709f/button_Login'))

'"Account will not be able to log in to the website\nAccount will be locked \nMessage ""You\'ve reached the maximum number of wrong login attempt allowed. Please contact your customer service."" will be displayed."\r\n\r\n\r\n'
WebUI.verifyElementText(findTestObject('Page_V9BET - Discover The Ultimate Gaming E_9e709f/ID_invalid_alert_message'), 'Account protected from login. Please contact Customer Service for assistance.')
